...
import Auxiliar.*;
// @author Radames
public class PacienteGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"CPF","Nome","Filiação","Doença","Data Nascimento","Genero"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public PacienteGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"CPF","Nome","Filiação","Doença","Data Nascimento","Genero"}, 0);
        int aux = 0;
